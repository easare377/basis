package org.odk.cersgis.basis.storage;
...
public class StoragePathProviderTest {
    ...
    public void setup() {
        ...
        doReturn("/storage/emulated/0/Android/data/org.odk.cersgis.basis/files").when(storagePathProvider).getScopedStorageRootDirPath();
    ...
    public void getStorageRootDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getStorageRootDirPath(), is("/storage/emulated/0/Android/data/org.odk.cersgis.basis/files"));
    }
