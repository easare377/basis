...
import org.odk.cersgis.basis.widgets.utilities.AudioFileRequester;
...
import static org.odk.cersgis.basis.support.RobolectricHelpers.setupMediaPlayerDataSource;
...
import static org.odk.cersgis.basis.widgets.support.QuestionWidgetHelpers.promptWithReadOnly;
import static org.odk.cersgis.basis.widgets.support.QuestionWidgetHelpers.promptWithReadOnlyAndAnswer;
...
public class AudioWidgetTest {
    ...
    /**
     * Currently choosing audio is locked into the {@link org.odk.cersgis.basis.tasks.MediaLoadingTask}
     * flow and so we'd need to rip this apart to let us drop support for accepting File as data. In
     * this case it will just grab the name off the file and use {@link org.odk.cersgis.basis.utilities.QuestionMediaManager}
