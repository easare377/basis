...
import org.odk.cersgis.basis.activities.CaptureSelfieVideoActivity;
...
import static org.odk.cersgis.basis.analytics.AnalyticsEvents.REQUEST_HIGH_RES_VIDEO;
import static org.odk.cersgis.basis.analytics.AnalyticsEvents.REQUEST_VIDEO_NOT_HIGH_RES;
...
public class VideoWidget extends QuestionWidget implements FileWidget, ButtonClickListener, WidgetDataReceiver {
     ...
     * @see org.odk.cersgis.basis.activities.FormEntryActivity#onActivityResult(int, int, Intent)
     */
    @Override
