...
import org.odk.cersgis.basis.dao.helpers.FormsDaoHelper;
import org.odk.cersgis.basis.dao.helpers.InstancesDaoHelper;
import org.odk.cersgis.basis.events.ReadPhoneStatePermissionRxEvent;
import org.odk.cersgis.basis.events.RxEventBus;
import org.odk.cersgis.basis.exception.JavaRosaException;
import org.odk.cersgis.basis.formentry.FormEntryMenuDelegate;
import org.odk.cersgis.basis.formentry.FormEntryViewModel;
import org.odk.cersgis.basis.formentry.FormIndexAnimationHandler;
import org.odk.cersgis.basis.formentry.FormIndexAnimationHandler.Direction;
import org.odk.cersgis.basis.formentry.FormLoadingDialogFragment;
import org.odk.cersgis.basis.formentry.ODKView;
import org.odk.cersgis.basis.formentry.QuitFormDialogFragment;
import org.odk.cersgis.basis.formentry.RecordingWarningDialogFragment;
import org.odk.cersgis.basis.formentry.audit.AuditEvent;
import org.odk.cersgis.basis.formentry.audit.AuditUtils;
import org.odk.cersgis.basis.formentry.audit.ChangesReasonPromptDialogFragment;
import org.odk.cersgis.basis.formentry.audit.IdentifyUserPromptDialogFragment;
import org.odk.cersgis.basis.formentry.audit.IdentityPromptViewModel;
import org.odk.cersgis.basis.formentry.backgroundlocation.BackgroundLocationManager;
import org.odk.cersgis.basis.formentry.backgroundlocation.BackgroundLocationViewModel;
import org.odk.cersgis.basis.formentry.loading.FormInstanceFileCreator;
import org.odk.cersgis.basis.formentry.repeats.AddRepeatDialog;
import org.odk.cersgis.basis.formentry.repeats.DeleteRepeatDialogFragment;
...
import org.odk.cersgis.basis.formentry.saving.SaveAnswerFileProgressDialogFragment;
...
import org.odk.cersgis.basis.fragments.MediaLoadingFragment;
import org.odk.cersgis.basis.fragments.dialogs.CustomDatePickerDialog;
import org.odk.cersgis.basis.fragments.dialogs.CustomTimePickerDialog;
import org.odk.cersgis.basis.fragments.dialogs.LocationProvidersDisabledDialog;
import org.odk.cersgis.basis.fragments.dialogs.NumberPickerDialog;
import org.odk.cersgis.basis.fragments.dialogs.ProgressDialogFragment;
import org.odk.cersgis.basis.fragments.dialogs.RankingWidgetDialog;
...
import org.odk.cersgis.basis.javarosawrapper.FormController.FailedConstraint;
import org.odk.cersgis.basis.listeners.AdvanceToNextListener;
import org.odk.cersgis.basis.listeners.FormLoaderListener;
import org.odk.cersgis.basis.listeners.PermissionListener;
import org.odk.cersgis.basis.listeners.SavePointListener;
import org.odk.cersgis.basis.listeners.SwipeHandler;
import org.odk.cersgis.basis.listeners.WidgetValueChangedListener;
import org.odk.cersgis.basis.logic.FormInfo;
import org.odk.cersgis.basis.logic.ImmutableDisplayableQuestion;
...
import org.odk.cersgis.basis.provider.InstanceProviderAPI.InstanceColumns;
...
import org.odk.cersgis.basis.tasks.SaveFormIndexTask;
import org.odk.cersgis.basis.tasks.SavePointTask;
import org.odk.cersgis.basis.utilities.ApplicationConstants;
import org.odk.cersgis.basis.utilities.DestroyableLifecyleOwner;
...
import org.odk.cersgis.basis.utilities.SnackbarUtils;
import org.odk.cersgis.basis.utilities.SoftKeyboardController;
import org.odk.cersgis.basis.utilities.ToastUtils;
import org.odk.cersgis.basis.widgets.DateTimeWidget;
import org.odk.cersgis.basis.widgets.QuestionWidget;
import org.odk.cersgis.basis.widgets.RangePickerDecimalWidget;
import org.odk.cersgis.basis.widgets.RangePickerIntegerWidget;
import org.odk.cersgis.basis.widgets.interfaces.WidgetDataReceiver;
import org.odk.cersgis.basis.widgets.utilities.FormControllerWaitingForDataRegistry;
import org.odk.cersgis.basis.widgets.utilities.ViewModelAudioPlayer;
...
import static org.odk.cersgis.basis.analytics.AnalyticsEvents.SAVE_INCOMPLETE;
import static org.odk.cersgis.basis.formentry.FormIndexAnimationHandler.Direction.BACKWARDS;
import static org.odk.cersgis.basis.formentry.FormIndexAnimationHandler.Direction.FORWARDS;
import static org.odk.cersgis.basis.fragments.BarcodeWidgetScannerFragment.BARCODE_RESULT_KEY;
import static org.odk.cersgis.basis.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.odk.cersgis.basis.utilities.AnimationUtils.areAnimationsEnabled;
import static org.odk.cersgis.basis.utilities.ApplicationConstants.RequestCodes;
import static org.odk.cersgis.basis.utilities.DialogUtils.getDialog;
import static org.odk.cersgis.basis.utilities.DialogUtils.showIfNotShowing;
import static org.odk.cersgis.basis.utilities.PermissionUtils.areStoragePermissionsGranted;
import static org.odk.cersgis.basis.utilities.PermissionUtils.finishAllActivities;
import static org.odk.cersgis.basis.utilities.ToastUtils.showLongToast;
import static org.odk.cersgis.basis.utilities.ToastUtils.showShortToast;
