...
import org.odk.cersgis.basis.openrosa.OpenRosaConstants;
...
import org.odk.cersgis.basis.support.MockedServerTest;
...
import static org.odk.cersgis.basis.support.TestUtils.assertMatches;
import static org.odk.cersgis.basis.support.TestUtils.cleanUpTempFiles;
import static org.odk.cersgis.basis.support.TestUtils.createTempFile;
import static org.odk.cersgis.basis.support.TestUtils.resetInstancesContentProvider;
...
public class InstanceServerUploaderTaskTest extends MockedServerTest {
    ...
    public void shouldUploadAnInstance() throws Exception {
        ...
        HEAD: {
            ...
            assertMatches("org.odk.cersgis.basis/.* Dalvik/.*", r.getHeader("User-Agent"));
